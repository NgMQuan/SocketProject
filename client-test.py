...
entry_username = tkinter.Entry (top, textvariable=usn)
entry_username.place ( x = 490, y = 200)
entry_password = tkinter.Entry (top, textvariable=pas)
entry_password.place ( x = 490, y = 240 )
entry_payId = tkinter.Entry (top, textvariable=pay)
